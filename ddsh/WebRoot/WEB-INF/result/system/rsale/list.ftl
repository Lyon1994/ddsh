...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<script language="javascript">
			...
			{
				var returnstr;
        		returnstr = window.showModalDialog('../html/rsale.jsp','',"dialogHeight: 500px; dialogWidth: 750px;center: yes; help: no;resizable: no; status: no;");
				load('');
			}
			function deletes()
			{
			...
			function load(param)
			{
				var b="<table class='maintab_content_table' width='100%'><thead><tr class='maintab_content_table_title'><th width='1%'><input type='checkbox' name='select' onclick='ck()'/></th><th>条形码</th><th>物品名称</th><th>折扣</th><th>数量</th><th>单价</th><th>总价</th><th>设计师</th><th>退回原因</th><th>操作人</th><th>操作日期</th></tr></thead><tbody>";
				var a="</tbody></table>";
				$.ajax({
		...
		<table border="0" width="100%" cellspacing="0" cellpadding=" height="30">
			<tr>
				<td height="30" valign="bottom">
					<img src="${images}/rsale.gif" onclick="sale()" style="cursor:hand" />
