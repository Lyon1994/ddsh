...
CREATE TABLE `dd_bill` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Index_1` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='电子钱包交易记录表';
...
INSERT INTO `dd_inventory` VALUES ('571', '10080916530548', '23424', '1', 'user1', '2012-02-06 01:46:17');
...
INSERT INTO `dd_product` VALUES ('2406', '10080916530473', '大头狗', '323.237', '1', '1', '20091003199_.gif', 'AB-all', '20*503', '20*503', '1', '400', '10', '2010-08-09 13:15:00', 'user1', '2010-08-14 18:49:25');
...
CREATE TABLE `dd_sales` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Index_1` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=189 DEFAULT CHARSET=utf8 COMMENT='售货记录表,卖出的数量要相应的从库存减去';
