    ...
    <head>
		...
		<script language="javascript">
			...
			function ok(obtn){
				...
				//alert(value);
				$.ajax({
					 	url: 'product!edit.zf?trid='+trid+'&tdid='+tdid+'&value='+value+'&t='+new Date().getTime(),
					 	type: 'POST',
					 	dataType: 'json',
		...
		<table border="0" width="100%" cellspacing="0" cellpadding=" height="30">
			<tr>
				<td height="30" valign="bottom">
					<a href="${base}/html/search_product.html"><img src='${images}/search.gif' id='search' alert='查询' style="cursor:hand" /></a>
