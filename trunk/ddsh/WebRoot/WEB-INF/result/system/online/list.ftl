    ...
    <head>
		...
		<script language="javascript">
			...
			function down()
			{
				...
				var returnstr;
        		returnstr = window.showModalDialog('../html/sell_down.jsp?id='+str.replace(',',''),'',"dialogHeight: 500px; dialogWidth: 750px;center: yes; help: no;resizable: no; status: no;");
				load('');
			...
			function load(param)
			{
				var b="<table class='maintab_content_table' width='100%'><thead><tr class='maintab_content_table_title'><th width='1%'><input type='checkbox' name='select' onclick='ck()'/></th><th>条形码</th><th>物品名称</th><th>格子编号</th><th>数量</th><th>单价</th><th>折扣</th><th>设计师</th></tr></thead><tbody>";
				var a="</tbody></table>";
				$.ajax({
