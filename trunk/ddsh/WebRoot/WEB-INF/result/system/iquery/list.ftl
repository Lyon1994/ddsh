		...
		<script language="javascript">
			...
			function load(param)
			{
				...
				$.ajax({
					 	...
					 	success: function(json){
							//蓝色主题
							$('#list').jpage({dataBefore:b,dataAfter:a,dataStore: null,themeName:'blue',totalRecord:json[0],proxyUrl:'iquery!result.zf?t='+new Date().getTime()+'&type=0',openCookies:false,
